...
- The authoritative 2026-08-30 root `npm run check` passes 53/53 test files and 628/628 tests, followed by successful client typechecking, server build, and production Vite build. Do not reuse the historical 18-file/133-test POC count.
